...
namespace FileCompressor
{
    ...
    public class IndividualFileHeaderInformation
    {
        ...
        /// <summary>
        /// This method returns the Individual file header as a byte array. It consists of a long (8 bytes) detailing the size of name of the file. Then the file name (x bytes long). 
